...
public partial class App : Application
{
    ...
    private void OnStartup(object sender, StartupEventArgs e)
    {
        try
        {
            ...
            _logger.LogInfo("=== TextSimulator Application Starting ===");
            ...
            _logger.LogInfo("=== TextSimulator Application Started Successfully ===");
    ...
    private void OnExit(object sender, ExitEventArgs e)
    {
        try
        {
            _logger?.LogInfo("=== TextSimulator Application Shutting Down ===");
            ...
            _logger?.LogInfo("=== TextSimulator Application Stopped ===");
        }
        catch (Exception ex)
        {
